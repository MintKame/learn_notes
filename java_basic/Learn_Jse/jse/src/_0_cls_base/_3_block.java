...
public class _3_block {
    ...
    //! exe order?
    // super cls loaded:
    //   1. init static property, static initBlock (same priority, depends by order)
    // sub cls loaded:
    //   2. init static property, static initBlock (same priority, depends by order)
    // super obj:
    //   3. init property, initBlock (same, priority, depends by order)
    //   4. ctor
    // sub obj:
    //   3. init property, initBlock (same, priority, depends by order)
    //   4. ctor
