...
//how to combine with thread ?
//pass connection to create Thread
public class __Thread {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        //    该方法的第一个参数是数据库的路径url
        Connection c = DriverManager.getConnection("jdbc:mysql://localhost/javabook?serverTimezone=UTC", "root", "0");
        ...
        ResultSet ret = st.executeQuery("select mi from Student");
